...
int main(int argc, char* argv[])
{
    ...
    for (int i = 0; i < nHosts; i++) {
        auto *R0R2Monitor = new PacketMonitor(startTime, stopTime + convergenceTime, racks[0].Get(i), racks[2].Get(i), "R0H" + to_string(i) + "R2H" + to_string(i));
    ...
    for (int i = 0; i < nHosts; i++) {
        auto *R1R3Monitor = new PacketMonitor(startTime, stopTime + convergenceTime, racks[1].Get(i), racks[3].Get(i), "R1H" + to_string(i) + "R3H" + to_string(i));
