...
class Ipv4GlobalRouting : public Ipv4RoutingProtocol
{
  public:
    ...
    // ****** Mahdi Change ***** (START) ***** // 
    /**
     * Return the 5-tuple  hash value of a packet
    */
    uint64_t GetHashValue(const Ipv4Header header, Ptr<const Packet> ipPayload);
    // ****** Mahdi Change ***** (END) ***** // 
  ...
  private:
    ...
    Ptr<Ipv4Route> LookupGlobal(Ipv4Address dest, const Ipv4Header& header, Ptr<const Packet> ipPayload, Ptr<NetDevice> oif = nullptr);
    // ****** Mahdi Change ***** (END) ***** // 
    ...
    // ****** Mahdi Change ***** (START) ***** // 
    Hasher m_hasher; //!< Hasher object to hash the packets
    // ****** Mahdi Change ***** (END) ***** // 
